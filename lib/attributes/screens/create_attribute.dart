...
class CreateAttribute extends StatefulWidget {
  const CreateAttribute({super.key});

  @override
  State<CreateAttribute> createState() => _CreateAttributeState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const PreferredSize(
          ...
          child: CommonAppBar(title: "Create New Attribute")),
            ...
            listener: (context, state) {
              ...
              if (state is CreateAttributeSuccess) {
                ...
                SuccessPopup().successAlert(
                    context, "Attribute has been created successfully!");
              }
