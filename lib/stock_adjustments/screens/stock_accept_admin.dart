...
class AdminStockAcceptancePopUp extends StatelessWidget {
  final StockAdjustmentListAdminModel receiveStockModel;
  const AdminStockAcceptancePopUp({super.key, required this.receiveStockModel});
        ...
        child: Column(
          children: [
            ...
            SizedBox(
              ...
              child: Center(
                child: Text(
                  "Requested By ${receiveStockModel.inventoryName}",
                  style: GoogleFonts.urbanist(
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      Text(
                        receiveStockModel.adjustmentType=="Increase"? 'Add Stock':'Remove Stock',
                        style: GoogleFonts.urbanist(
                          color:  receiveStockModel.adjustmentType=="Increase"?  Color(0xFF4CAF50):ColorTheme.red,
                          fontSize: 16.sp,
                          fontWeight: FontWeight.w600,
                          height: 0,
                        ),
                      ),Spacer(), Text(
                        '${receiveStockModel.quantity}',
                        style: GoogleFonts.urbanist(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(width: w1,height: MediaQuery.of(context).size.height/10,
                        child: Text(receiveStockModel.reason??"",
                          style: GoogleFonts.urbanist(
                            color: ColorTheme.secondary,
                            fontSize: 14.sp,
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: CommonButton(
                      onTap: () {
                        StoreDataSource().stockApproveByAdmin(receivingId: receiveStockModel.id??0).then((value) {
                          if (value.data1) {
